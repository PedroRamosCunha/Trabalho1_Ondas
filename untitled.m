...
h1 = figure('Name','Tensão e Corrente das fontes 1 e Rl = Infinito','NumberTitle','off');	%Abre uma janela genérica para receber os gráficos
...
h1 = figure('Name','Tensão e Corrente das fontes 1 e Rl = 0','NumberTitle','off');	%Abre uma janela genérica para receber os gráficos
for n=0:dt:t          %Loop de atualização dos gráficos
...
elseif button == 3
	...
	h1 = figure('Name','Tensão e Corrente das fontes 1 e Rl = 100 Ohms','NumberTitle','off');	%Abre uma janela genérica para receber os gráficos
for n=0:dt:t          %Loop de atualização dos gráficos
